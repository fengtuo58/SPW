...
//	void detach(){cout<<"detached Dog:"<<*this<<endl;if(--refcount==0)delete this;}
//	Dog*unalias(){cout<<"Unaliasing Dog:"<<*this<<endl;if(refcount==1)return this;--refcount;return new Dog(*this);}
...
//		DogHouse(const DogHouse& dh):p(dh.p),houseName("copy-construted"+dh.houseName){p->attach();cout<<"DogHouse copy-constructor:"<<*this<<endl;}
//		DogHouse& operator=(const DogHouse&dh)
//		{
//			if(&dh!=this)
//			{
//				houseName=dh.houseName+"assigned";
//			p->detach();p=dh.p;p->attach();
//			}
...
//	int main()
//	{
//		DogHouse fidos(Dog::make("fidos"),"FidoHOuse"),spots(Dog::make("spot"),"spothouse");
